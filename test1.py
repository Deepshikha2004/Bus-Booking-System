...
class bus_booking:
    ...
    def cover_page(self):
        ...
        Label(root, text="\n\n\n\n\nName: Deepshikha Singh", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="\nEnr : 221B136", font='Arial 16 bold', fg='blue').pack()
    ...
    def check_booking_page(self):
        ...
        def check_tkt():
            ...
            if len(mobile)==10 and mobile.isdigit():
                ...
                frame1=Frame(root,highlightbackground='black',highlightthickness=3)
                frame1.grid(row=5,column=2,columnspan=12)
                Label(text="YOUR TICKET", font='Arial 12 bold', bg='black',fg='white').grid(row=6,column=4,columnspan=8 )
                Label(frame1,text="Booking Reference = "+b_ref,font='Arial 12 bold', fg='black').grid(row=7,column=4)
                Label(frame1,text="Name : " + name, font='Arial 12 bold',fg='black').grid(row=8, column=4)
                Label(frame1,text="Gender :" + gen, font='Arial 12 bold', fg='black').grid(row=9, column=4)
                Label(frame1,text="NUMBER of seats : " + str(seat), font='Arial 12 bold', fg='black').grid(row=10, column=4)
                Label(frame1,text="Age : " + str(age), font='Arial 12 bold', fg='black').grid(row=11, column=4)
                Label(frame1,text="Booked on : " + book_date, font='Arial 12 bold', fg='black').grid(row=12, column=4)
                Label(frame1,text="Travel Date : " + travel_date, font='Arial 12 bold', fg='black').grid(row=13, column=4)
                Label(frame1,text="Fare : " + str(fare), font='Arial 12 bold', fg='black').grid(row=14, column=4)
                Label(frame1,text="Total fare : " + str(fare*seat), font='Arial 12 bold', fg='black').grid(row=15, column=4)
